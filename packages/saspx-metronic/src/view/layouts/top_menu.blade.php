            ...
            <div class="d-flex align-items-stretch" id="kt_header_nav">
                ...
                <div class="header-menu align-items-stretch" data-kt-drawer="true" data-kt-drawer-name="header-menu"
                    ...
                    <div
                        ...
                        @forelse(metronic_nav_menu_handler() as $nav => $navValue)
                            @if(isset($navValue['access']) && metronic_user_access_check($navValue['access']))
                                <div data-kt-menu-trigger="click" data-kt-menu-placement="bottom-start"
                                     class="menu-item menu-lg-down-accordion me-lg-1">
												<span class="menu-link py-3">
													<span class="menu-title">
                                                        {{ $navValue['title'] ?? 'Menu Item' }}
                                                    </span>
													<span class="menu-arrow d-lg-none"></span>
												</span>
                                    @if(isset($navValue['items']))

                                        <div
                                            class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-rounded-0 py-lg-4 w-lg-225px">
                                            @forelse($navValue['items'] as $nav_menu_item => $nav_menu_value)
                                                @if(isset($nav_menu_value['access']) && metronic_user_access_check($nav_menu_value['access']))
                                                    ...
                                                    <div data-kt-menu-trigger="{default:'click', lg: 'hover'}"
														...
														<span class="menu-link py-3">
                                                                <span class="menu-icon">
                                                                   @if(isset($nav_menu_value['icon']))
                                                                        <span
                                                                            class="{{ $nav_menu_value['icon'] }}"></span>
                                                                    @else
                                                                 ...
                                                                 <a href="{{ metronic_menu_url($nav_menu_value['url'] ?? '#') }}">
                                                                <span
                                                                    class="menu-title">{{ $nav_menu_value['text'] }}</span>
                                                            </a>
														</span>
                                                    </div>
                                                @endif
                                                ...
                                                <div class="symbol symbol-40px me-4">
																		<span class="symbol-label bg-light">
																			<img class="w-20px h-20px"
                                                                                 src="{{ metronic_assets() }}/media/svg/brand-logos/volicity-9.svg"
                                                                                 alt=""/>
																		</span>
                                                </div>
                                                <!--end::Symbol-->
                                            ...
                                            <a href="#"
                                               class="d-flex text-dark text-hover-primary align-items-center mb-5">
                                                ...
                                                <div class="symbol symbol-40px me-4">
																		<span class="symbol-label bg-light">
																			<img class="w-20px h-20px"
                                                                                 src="{{ metronic_assets() }}/media/svg/brand-logos/tvit.svg"
                                                                                 alt=""/>
																		</span>
                                                </div>
                                                <!--end::Symbol-->
                                            ...
                                            <a href="#"
                                               class="d-flex text-dark text-hover-primary align-items-center mb-5">
                                                ...
                                                <div class="symbol symbol-40px me-4">
																		<span class="symbol-label bg-light">
																			<img class="w-20px h-20px"
                                                                                 src="{{ metronic_assets() }}/media/svg/misc/infography.svg"
                                                                                 alt=""/>
																		</span>
                                                </div>
                                                <!--end::Symbol-->
                                            ...
                                            <a href="#"
                                               class="d-flex text-dark text-hover-primary align-items-center mb-5">
                                                ...
                                                <div class="symbol symbol-40px me-4">
																		<span class="symbol-label bg-light">
																			<img class="w-20px h-20px"
                                                                                 src="{{ metronic_assets() }}/media/svg/brand-logos/leaf.svg"
                                                                                 alt=""/>
																		</span>
                                                </div>
                                                <!--end::Symbol-->
                                            ...
                                            <a href="#"
                                               class="d-flex text-dark text-hover-primary align-items-center mb-5">
                                                ...
                                                <div class="symbol symbol-40px me-4">
																		<span class="symbol-label bg-light">
																			<img class="w-20px h-20px"
                                                                                 src="{{ metronic_assets() }}/media/svg/brand-logos/tower.svg"
                                                                                 alt=""/>
																		</span>
                                                </div>
                                                <!--end::Symbol-->
                    ...
                    <div class="d-flex align-items-center ms-1 ms-lg-3">
                        ...
                        <div class="menu menu-sub menu-sub-dropdown menu-column w-350px w-lg-375px" data-kt-menu="true">
                            ...
                            <div class="d-flex flex-column bgi-no-repeat rounded-top"
                                 style="background-image:url('{{ metronic_assets() }}/media/misc/pattern-1.jpg')">
                                <!--begin::Title-->
                                    ...
                                    <div class="d-flex flex-column px-9">
                                        ...
                                        <div class="text-center px-4">
                                            <img class="mw-100 mh-200px" alt="image"
                                                 src="{{ metronic_assets() }}/media/illustrations/sketchy-1/1.png"/>
                                        </div>
                                        <!--end::Illustration-->
                                    </div>
                                    <!--end::Wrapper-->
                            ...
                            <div class="menu-item px-5" data-kt-menu-trigger="hover"
                                ...
                                <a href="#" class="menu-link px-5">
														...
														<img class="w-15px h-15px rounded-1 ms-2"
                                                             src="{{ metronic_assets() }}/media/flags/united-states.svg"
                                                             alt=""/></span></span>
                                </a>
                                <!--begin::Menu sub-->
                                <div class="menu-sub menu-sub-dropdown w-175px py-4">
                                    ...
                                    <div class="menu-item px-3">
                                        <a href="../../demo1/dist/account/settings.html" class="menu-link d-flex px-5">
															<span class="symbol symbol-20px me-4">
																<img class="rounded-1"
                                                                     src="{{ metronic_assets() }}/media/flags/spain.svg"
                                                                     alt=""/>
															</span>Spanish</a>
                                    </div>
                                    <!--end::Menu item-->
                                    ...
                                    <div class="menu-item px-3">
                                        <a href="../../demo1/dist/account/settings.html" class="menu-link d-flex px-5">
															<span class="symbol symbol-20px me-4">
																<img class="rounded-1"
                                                                     src="{{ metronic_assets() }}/media/flags/germany.svg"
                                                                     alt=""/>
															</span>German</a>
                                    </div>
                                    <!--end::Menu item-->
                                    ...
                                    <div class="menu-item px-3">
                                        <a href="../../demo1/dist/account/settings.html" class="menu-link d-flex px-5">
															<span class="symbol symbol-20px me-4">
																<img class="rounded-1"
                                                                     src="{{ metronic_assets() }}/media/flags/japan.svg"
                                                                     alt=""/>
															</span>Japanese</a>
                                    </div>
                                    <!--end::Menu item-->
                                    ...
                                    <div class="menu-item px-3">
                                        <a href="../../demo1/dist/account/settings.html" class="menu-link d-flex px-5">
															<span class="symbol symbol-20px me-4">
																<img class="rounded-1"
                                                                     src="{{ metronic_assets() }}/media/flags/france.svg"
                                                                     alt=""/>
															</span>French</a>
                                    </div>
                                    <!--end::Menu item-->
