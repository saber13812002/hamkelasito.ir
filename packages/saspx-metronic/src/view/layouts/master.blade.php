...
<head><base href="">
   <title>
    ...
    <link href="{{ metronic_assets() }}/plugins/custom/fullcalendar/fullcalendar.bundle.css" rel="stylesheet"
          type="text/css"/>
...
<div class="d-flex flex-column flex-root">
    ...
    <div class="page d-flex flex-row flex-column-fluid">
        @include('MetronicView::layouts.aside_menu')

        <!--begin::Wrapper-->
        <div class="wrapper d-flex flex-column flex-row-fluid" id="kt_wrapper">
            @include('MetronicView::layouts.top_menu')
            <!--begin::Content-->
            <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
                <!--begin::Toolbar-->
                @include('MetronicView::layouts.toolbar')
                <!--end::Toolbar-->
                <!--begin::Post-->
            ...
            <!--end::Content-->
            @include('MetronicView::layouts.footer')
...
<script src="{{ metronic_assets() }}/plugins/custom/fullcalendar/fullcalendar.bundle.js"></script>
