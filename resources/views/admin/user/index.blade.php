            ...
            <div class="card">
                ...
                <div class="card-header">
                    <h3 class="card-title align-items-start flex-column">
                        <span class="card-label fw-bolder text-dark">{{__('Users Management')}}</span>
                    </h3>
                ...
                <div class="card-body table-responsive">
                    <table class="table align-middle table-row-dashed fs-6 gy-5 mb-0 dataTable no-footer" id="users_table">
                        ...
                        <tr>
                            ...
                            <th class="p-4">{{__('enable')}}</th>
                            <th class="p-4">{{__('Created At')}}</th>
                            <th class="p-4">{{__('Updated At')}}</th>
                            <th class="p-4">{{__('Options')}}</th>
                        </tr>
                        </thead>
                        ...
                        @foreach ($users as $item)
                            ...
                            <tr id="#user{{$item->id}}">
                                ...
                                <td class="p-5">{{$item->email_verified_at}}</td>
                                <td class="p-5">{{$item->created_at}}</td>
                                <td class="p-5">{{$item->updated_at}}</td>
                                <td class="p-5">
                                    <div class="btn-group">
                                        <!--begin::Update-->
                ...
                <div class="card-header">
                    <h3 class="card-title align-items-start flex-column">
                        <span class="card-label fw-bolder text-dark">Page : {{ $users->currentPage() }}</span>
                    ...
                    <div class="card-toolbar">
                        @include('MetronicView::parts.paginate',['paginator' => $users])
                    </div>
                </div>
                <!-- /.card-body -->
            </div>
