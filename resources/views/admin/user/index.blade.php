                    ...
                    <div class=" table-responsive p-0">
                        <table class="table table-row-bordered table-row-gray-100 align-middle gs-0 gy-3"
                            ...
                            <tr class="fw-bolder text-muted">
                                ...
                                <th class="p-0 w-50px">{{__('Name')}}</th>
                                <th class="p-0 w-50px">{{__('Email')}}</th>
                                <th class="p-0 w-50px">{{__('enable')}}</th>
                                <th class="p-0 w-50px">{{__('Created At')}}</th>
                                <th class="p-0 w-50px">{{__('Updated At')}}</th>
                                <th class="p-0 w-50px">{{__('Options')}}</th>
                            </tr>
                            </thead>
                            <tbody>
                            @php
