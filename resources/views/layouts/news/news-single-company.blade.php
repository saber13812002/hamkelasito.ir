        ...
        <section class="section section-content">
            <div class="container-xxl" itemscope itemtype="https://schema.org/NewsArticle">
                        ...
                        <div class="row align-items-center">
                            <div class="col-auto">
                                <div class="post-author">
                                    <div class="post-author-thumbnail">
                                        <img src="/storage/assets/img/profile/profile-1/Thumbnail/profile-001.webp"
                                             alt="Author"/>
                                        <!--                                        <i class="icon-user"></i>-->
                                    </div>
                            ...
                            <div class="col-12">
                                <div class="post-categories" itemscope itemtype="https://schema.org/CategoryCodeSet">
                                    <a href="#" itemprop="hasCategoryCode" itemscope
                ...
                <div class="row">
                    ...
                    @include('layouts.news.article-body')

                    @include('layouts.news.post-side')
