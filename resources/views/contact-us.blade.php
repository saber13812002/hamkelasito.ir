                ...
                <div class="row contact-links-content">
                    <div class="col-12 col-md-6 col-lg-5">
                        <p class="contact-notice">
                            For work requests, other questions, inquiries, etc., please contact us using the form in this page
                        </p>
                        ...
                        <div class="social-network">
                            ...
                            <div class="social-links">
                                <a href="https://www.facebook.com/liliana.modeling/" class="btn btn-icon" aria-label="Facebook Link" itemprop="sameAs">
                                    <i class="icon-facebook"></i>
                                </a>
                                <a href="https://www.instagram.com/Liliana.models/" class="btn btn-icon" aria-label="Instagram Link" itemprop="sameAs">
                                    <i class="icon-instagram"></i>
                                </a>
                                <a href="https://www.tiktok.com/@lilianamodels" class="btn btn-icon" aria-label="Tiktok Link" itemprop="sameAs">
                                    <i class="icon-Tiktok"></i>
                                </a>
                                <a href="https://twitter.com/lilianamodels" class="btn btn-icon" aria-label="Twitter Link" itemprop="sameAs">
                                    <i class="icon-twitter"></i>
                                </a>
                                <a href="https://www.linkedin.com/company/liliana-modeling" class="btn btn-icon" aria-label="LinkedIn Link" itemprop="sameAs">
                            ...
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <div class="field field-type-select" data-field-defualt-text=" "
                                        ...
                                        <div class="field-content">
                                            <label for="field_category">Select Category <span class="field-required-star">*</span></label>
                                            <select name="category" id="field_category">
                                                <option value="introduction_to_liliana">Introduction to Liliana</option>
                                                <option value="joining_liliana">Joining Liliana</option>
                                                <option value="member_support">Member Support</option>
                                                <option value="customer_support">Customer Support</option>
                                                <option value="starting_a_new_project">Starting a New Project</option>
                                ...
                                <!-- message -->
                                <div class="col-12">
                                    <div class="field field-type-text-area" data-type="textarea" data-required="true" data-max-length="1500">
                                        <div class="field-content">
                                            <label for="field_message">Message <span class="field-required-star">*</span></label>
