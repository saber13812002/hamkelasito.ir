        ...
        <div id="content">
                                        ...
                                        <div class="row">
                                                ...
                                                <div class="heading">
                                                    <div class="top-area">
                                                        ...
                                                        <div class="action-area">
                                                            <button type="button" class="btn btn-icon btn-open-edit-form"
                                                                    data-target="edit_form_step_1" aria-label="edit basic info">
                                                                <i class="icon-edit"></i>
                                                            </button>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="col-12">
                                                        ...
                                                        <div class="image-preview-item">
                                                            <a href="/storage/assets/img/3x4/024.webp" target="_blank">
                                                                <img src="/storage/assets/img/lazy-3x4.webp" class="lazy"
                                                                     data-src="/storage/assets/img/3x4/024.webp" width="320"
                                                                     height="426" alt="Liliana">
                                                                <noscript>
                                                                    <img src="/storage/assets/img/3x4/024.webp" width="88" height="24" alt="Liliana">
                                                                </noscript>
                                                            </a>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="final-check-table">
                                                    ...
                                                    <div class="table-row">
                                                        ...
                                                        <div class="table-col">
                                                            <div class="check-item">
                                                                ...
                                                                <div class="check-value" data-input-watcher="first_name_furigana"
                                                                     data-input-watcher-type="text">
                                                                    -
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div class="table-row">
                                                        <div class="table-col col-full-width">
                                                            <div class="check-item">
                                                                ...
                                                                <div class="check-value" data-input-watcher="middle_name"
                                                                     data-input-watcher-type="text">
                                                                    -
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div class="table-row">
                                                        ...
                                                        <div class="table-col">
                                                            <div class="check-item">
                                                                ...
                                                                <div class="check-value" data-input-watcher="last_name_furigana"
                                                                     data-input-watcher-type="text">
                                                                    -
                                                                </div>
                                                            </div>
                                                    ...
                                                    <!-- other nationality -->
                                                    <div class="table-row" data-dependency=".have_other_nationality" data-dependency-value="yes">
                                                        <div class="table-col col-full-width">
                                                            <div class="check-item">
                                                    ...
                                                    <div class="table-row border-top" data-dependency=".are_you_mixed" data-dependency-value="yes">
                                                        <div class="table-col">
                                                            <div class="check-item">
                                            ...
                                            <div class="col-12">
                                                <div class="heading">
                                                    <div class="top-area">
                                                        ...
                                                        <div class="action-area">
                                                            <button type="button" class="btn btn-icon btn-open-edit-form"
                                                                    data-target="edit_form_step_2" aria-label="edit physical info">
                                                                <i class="icon-edit"></i>
                                                            </button>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="table-row">
                                                        ...
                                                        <div class="table-col">
                                                            <div class="check-item">
                                                                ...
                                                                <div class="check-value">
                                                                <span data-input-watcher="shoe_jp_size" data-input-watcher-type="select"
                                                                      data-dependency="#size_unit" data-dependency-value="jp">
                                                                    28
                                                                </span>
                                                                    <span data-input-watcher="shoe_uk_size" data-input-watcher-type="select"
                                                                          data-dependency="#size_unit" data-dependency-value="uk">
                                                                    -
                                                                </span>
                                                                    <span data-input-watcher="shoe_us_men_size" data-input-watcher-type="select"
                                                                          data-dependency="#size_unit" data-dependency-value="us">
                                                                    -
                                                                </span>
                                                                    <span data-input-watcher="shoe_us_women_size" data-input-watcher-type="select"
                                                                          data-dependency="#size_unit" data-dependency-value="us">
                                                                    -
                                                                </span>
                                                                    <span data-input-watcher="shoe_eu_size" data-input-watcher-type="select"
                                                                          data-dependency="#size_unit" data-dependency-value="eu">
                                                                    -
                                                                </span>
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                <div class="heading">
                                                    <div class="top-area">
                                                        ...
                                                        <div class="action-area">
                                                            <button type="button" class="btn btn-icon btn-open-edit-form"
                                                                    data-target="edit_form_step_3" aria-label="edit skills and experiences">
                                                                <i class="icon-edit"></i>
                                                            </button>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="col-12">
                                                <div class="final-check-table">
                                                    ...
                                                    <div class="live-table-repeater" id="other_language_live_table_repeater">
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                <div class="heading">
                                                    <div class="top-area">
                                                        ...
                                                        <div class="action-area">
                                                            <button type="button" class="btn btn-icon btn-open-edit-form"
                                                                    data-target="edit_form_step_4" aria-label="edit photos">
                                                                <i class="icon-edit"></i>
                                                            </button>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="col-12">
                                                <div class="row justify-content-center">
                                                    <div class="col-auto visible-desktop">
                                                        ...
                                                        <div class="image-preview single-preview"
                                                             ...
                                                             data-input-watcher-type="image" data-default-count="1">
                                                            <div class="image-preview-item">
                                                                <a href="/storage/assets/img/3x4/026.webp" target="_blank">
                                                                    <img src="/storage/assets/img/lazy-3x4.webp" class="lazy"
                                                                         data-src="/storage/assets/img/3x4/024.webp" width="320"
                                                                         height="426" alt="Liliana">
                                                                    <noscript>
                                                    ...
                                                    <div class="col-auto">
                                                        ...
                                                        <div class="image-preview single-preview is-full"
                                                            ...
                                                            <div class="image-preview-item">
                                                                <a href="/storage/assets/img/3x4/026.webp" target="_blank">
                                                                    <img src="/storage/assets/img/lazy-3x4.webp" class="lazy"
                                                                         data-src="/storage/assets/img/3x4/026.webp" width="320"
                                                                         height="426" alt="Liliana">
                                                                    <noscript>
                                                                        <img src="/storage/assets/img/3x4/026.webp" width="88" height="24" alt="Liliana">
                                                                    </noscript>
                                                                </a>
                                                            </div>
                                                        </div>
                                                ...
                                                <div data-dependency="#other_photos" data-dependency-value="tempCheck">
                                                    ...
                                                    <div class="image-preview multi-preview" data-input-watcher="other_photos"
                                                         data-input-watcher-type="image" data-default-count="4">
                                                        <div class="image-preview-item">
                                                            <a href="/storage/assets/img/3x4/012.webp" target="_blank">
                                                                <img src="/storage/assets/img/lazy-3x4.webp" class="lazy"
                                                                     data-src="/storage/assets/img/3x4/012.webp" width="320"
                                                                     height="426" alt="Liliana">
                                                                <noscript>
                                                                    <img src="/storage/assets/img/3x4/012.webp" width="88" height="24" alt="Liliana">
                                                                </noscript>
                                                            </a>
                                                        </div>
                                                        <div class="image-preview-item">
                                                            <a href="/storage/assets/img/3x4/006.webp" target="_blank">
                                                                <img src="/storage/assets/img/lazy-3x4.webp" class="lazy"
                                                                     data-src="/storage/assets/img/3x4/006.webp" width="320"
                                                                     height="426" alt="Liliana">
                                                                <noscript>
                                                                    <img src="/storage/assets/img/3x4/006.webp" width="88" height="24" alt="Liliana">
                                                                </noscript>
                                                            </a>
                                                        </div>
                                                        <div class="image-preview-item">
                                                            <a href="/storage/assets/img/3x4/020.webp" target="_blank">
                                                                <img src="/storage/assets/img/lazy-3x4.webp" class="lazy"
                                                                     data-src="/storage/assets/img/3x4/020.webp" width="320"
                                                                     height="426" alt="Liliana">
                                                                <noscript>
                                                                    <img src="/storage/assets/img/3x4/020.webp" width="88" height="24" alt="Liliana">
                                                                </noscript>
                                                            </a>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="col-12">
                                                <div class="heading">
                                                    <div class="top-area">
                                                        ...
                                                        <div class="action-area">
                                                            <button type="button" class="btn btn-icon btn-open-edit-form"
                                                                    data-target="edit_form_step_5" aria-label="edit contact info">
                                                                <i class="icon-edit"></i>
                                                            </button>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="table-row">
                                                        <div class="table-col col-full-width">
                                                            <div class="check-item">
                                                                ...
                                                                <div class="check-value">
                                                                    <span data-input-watcher="country_code">+81</span>-<span data-input-watcher="mobile_number">32005765</span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                <div class="heading">
                                                    <div class="top-area">
                                                        ...
                                                        <div class="action-area">
                                                            <button type="button" class="btn btn-icon btn-open-edit-form"
                                                                    data-target="edit_form_step_6" aria-label="edit bank and visa">
                                                                <i class="icon-edit"></i>
                                                            </button>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="col-12">
                                                <div class="final-check-table">
                                                    ...
                                                    <div class="table-row dependency-event" data-dependency="#authentication_type" data-dependency-value="passport">
                                                        <div class="table-col col-full-width">
                                                            <div class="check-item ">
                                                                <div class="check-label">Passport Photo:</div>
                                                                <div class="check-value image-preview-eye" data-input-watcher="passport_photo" data-default-count="2">
                                                                    <button type="button" class="image-preview-eye-button" data-images="[&quot;https://liliana.asensive.ir/assets/img/passport.png&quot;]"><i class="icon-eye"></i></button>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="table-row dependency-event" data-dependency="#authentication_type" data-dependency-value="drive_license">
                                                        <div class="table-col">
                                                            <div class="check-item ">
                                                                <div class="check-label">Front Photo of Driver's License:</div>
                                                                <div class="check-value image-preview-eye" data-input-watcher="front_photo_drive_license_card" data-default-count="2">
                                                                    -
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="table-row dependency-event" data-dependency="#authentication_type" data-dependency-value="insurance_card">
                                                        <div class="table-col">
                                                            <div class="check-item ">
                                                                <div class="check-label">Front Photo of Insurance Card:</div>
                                                                <div class="check-value image-preview-eye" data-input-watcher="front_photo_insurance_card" data-default-count="2">
                                                                    -
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="table-row dependency-event" data-dependency="#authentication_type" data-dependency-value="my_number_card">
                                                        <div class="table-col">
                                                            <div class="check-item ">
                                                                <div class="check-label">Front Photo of My Number Card:</div>
                                                                <div class="check-value image-preview-eye" data-input-watcher="front_photo_my_number_card" data-default-count="2">
                                                                    -
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="table-col">
                                                            <div class="check-item ">
                                                                ...
                                                                <div class="check-value image-preview-eye" data-input-watcher="back_photo_my_number_card" data-default-count="2">
                                                                    -
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="table-row dependency-event" data-dependency="#authentication_type" data-dependency-value="residence_card">
                                                        <div class="table-col">
                                                            <div class="check-item ">
                                                                <div class="check-label">Front Photo of Residence Card:</div>
                                                                <div class="check-value image-preview-eye" data-input-watcher="front_photo_residence_card" data-default-count="2">
                                                                    -
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="table-col">
                                                            <div class="check-item ">
                                                                ...
                                                                <div class="check-value image-preview-eye" data-input-watcher="back_photo_residence_card" data-default-count="2">
                                                                    -
                                                                </div>
                                                            </div>
                                                        </div>
                ...
                <div class="edit-form-content">
                    ...
                    <div class="form-section">
                        ...
                        <div class="form-section-content">
                            ...
                            <div class="table-repeater" data-name="Other Languages" data-unique="language" data-unique-message="The chosen language is already selected. Please choose a different language or edit the current selection" data-live="other_language_live_table_repeater">
                    ...
                    <div class="form-section">
                        ...
                        <div class="form-section-content">
                            <div class="table-repeater" data-name="Skill" data-required="true" data-live="skills_live_table_repeater"  data-custom-column="[{&quot;name&quot;: &quot;tags&quot;, &quot;text&quot;: &quot;Skill Tags&quot;}]">
                    ...
                    <div class="form-section">
                        ...
                        <div class="form-section-content">
                            ...
                            <div class="table-repeater" id="table_job_experiences_manual" data-class="job-exp-table-repeater-popup" data-exclusive="type" data-exclusive-value="no_job_experience" data-exclusive-empty-element-check="job_experiences_pdf" data-name="Job Experiences" data-live="job_exp_table_repeater" data-required="true">
                ...
                <div class="edit-form-content">
                        ...
                        <div class="form-section-content">
                            <div>
                                <div class="field field-type-upload" data-type="upload" data-required="true">
                                    <div class="upload-drop-zone" data-limit-count="1" data-limit-size="10" data-ratio="3/4" data-accept=".png,.jpg" data-default="[{&quot;id&quot;:115329,&quot;type&quot;:&quot;photo&quot;,&quot;name&quot;:&quot;File Name&quot;,&quot;thumbnail&quot;:&quot;https://liliana.asensive.ir/assets/img/3x4/024.webp&quot;,&quot;url&quot;:&quot;https://liliana.asensive.ir/assets/img/3x4/024.webp&quot;,&quot;req&quot;:&quot;[&quot;}]">
                                        <input type="hidden" class="input-drop-zone" name="profile_image" id="profile_image">
                                        <label>Waist Up Photo</label>
                                        <i class="icon-upload"></i>
                                        <div class="upload-title">
                                            <b>Click to upload</b> <span class="visible-desktop">or drag and drop</span> your waist up photo <span class="field-required-star">*</span>
                                        </div>
                                        <div class="upload-description">
                    ...
                    <div class="form-section">
                        ...
                        <div class="form-section-content">
                            <div>
                                <div class="field field-type-upload" data-type="upload" data-required="true">
                                    <div class="upload-drop-zone" data-limit-count="1" data-limit-size="10" data-ratio="3/4" data-accept=".png,.jpg" data-default="[{&quot;id&quot;:115329,&quot;type&quot;:&quot;photo&quot;,&quot;name&quot;:&quot;File Name&quot;,&quot;thumbnail&quot;:&quot;https://liliana.asensive.ir/assets/img/3x4/026.webp&quot;,&quot;url&quot;:&quot;https://liliana.asensive.ir/assets/img/3x4/026.webp&quot;,&quot;req&quot;:&quot;[&quot;}]">
                                        <input type="hidden" class="input-drop-zone" name="full_length_photo" id="full_length_photo">
                                        <label>Full Length Photo</label>
                                        <i class="icon-upload"></i>
                                        <div class="upload-title">
                                            <b>Click to upload</b> <span class="visible-desktop">or drag and drop</span> your full length photo <span class="field-required-star">*</span>
                                        </div>
                                        <div class="upload-description">
                                            Allowed format: PNG, JPG (Up to: 1 photo/10 Mb)
                                        </div>
                                ...
                                <div class="col-6">
                                    <div class="field field-type-select"
                                        ...
                                        <div class="field-content">
                                            ...
                                            <select name="state" id="state" data-value="Japan" data-default-value="Japan"></select>
                                            <i class="icon-arrow-down"></i>
                                        </div>
                                    </div>
                                ...
                                <div class="col-6">
                                    <div class="field field-type-select"
                                        ...
                                        <div class="field-content">
                                            ...
                                            <select name="city" id="city" data-value="Japan" data-default-value="Japan"></select>
                                            <i class="icon-arrow-down"></i>
                                        </div>
                                    </div>
                ...
                <div class="edit-form-content">
                    ...
                    <div class="form-section" data-dependency="#authentication_type" data-dependency-value="passport">
                        ...
                        <div class="form-section-content">
                            <div>
                                <div class="field field-type-upload" data-type="upload" data-required="true">
                                    <div class="upload-drop-zone" data-limit-count="1" data-limit-size="10" data-accept=".png,.jpg" data-default="[{&quot;id&quot;:346479,&quot;type&quot;:&quot;photo&quot;,&quot;name&quot;:&quot;File Name&quot;,&quot;thumbnail&quot;:&quot;https://liliana.asensive.ir/assets/img/passport.png&quot;,&quot;req&quot;:&quot;[&quot;}]">
            ...
            <div class="photo-guide profile-photo-guide">
                ...
                <div class="photo-guide-content">
                    <img src="/storage/assets/img/photo-guides/Profile-Photo.webp" width="320" height="280" alt="Waist Up Photo Guide">
                    <p>
                        A standout waist up photo should clearly highlight your face, with room above your head and below your shoulders. Natural lighting, like from a window or on a cloudy day, is best as it avoids harsh shadows. Choose images with a plain or non-distracting background to make sure you're the focal point. Your expression should be genuine, be it a smile or a calm look. Photos from a newer smartphone with good clarity work well. Dress neatly, and if you're wearing makeup, keep it subtle.
                    </p>
                </div>
            ...
            <div class="photo-guide full-length-photo-guide">
                ...
                <div class="photo-guide-content">
                    <img src="/storage/assets/img/photo-guides/Full-Length-Photo.webp" width="320" height="280" alt="Full Length Photo Guide">
                    <p>
                        An outstanding full length photo should have you standing straight but relaxed. Good lighting is essential; it should illuminate your face and body evenly without casting harsh shadows or making you appear washed out. A simple background helps keep the focus on you. The entire photo should be proportional, suggesting it was taken with the camera around chest height. Dress professionally, ensuring your clothes fit well, and pair with appropriate shoes. Before settling on a choice, make sure the photo is clear and truly represents your best self.
                    </p>
                </div>
                <div class="photo-guide-footer">
                    <button type="button"
            ...
            <div class="photo-guide other-photo-guide">
                ...
                <div class="photo-guide-content">
                    <img src="/storage/assets/img/photo-guides/Other-Photo.webp" width="320" height="280" alt="Other Photos Guide">
                    <p>
                        By uploading diverse images that showcase various poses, styles, and different make ups, you significantly increase your chances of receiving job offers. Clear, well-lit photos create a lasting impression on potential clients, allowing them to see your versatility and professionalism. It's crucial to ensure the quality of your images, highlighting your attention to detail and dedication to excellence. We recommend providing up to 20 high-quality images to comprehensively display your range of skills and unique personality. This proactive approach distinguishes you from others, opening doors to more opportunities and career advancement.
                    </p>
                </div>
                <div class="photo-guide-footer">
                    <button type="button"
