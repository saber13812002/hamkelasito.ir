                        ...
                        <div class="step-content step-skills active" data-step="3">
                            <div class="container-lg">
                                        ...
                                        <div class="notification-content">
                                            ...
                                            <div class="notification-inner-content">
                                                <div class="notification-title">
                                                    You will significantly increase your chances of receiving better
                                                    offers if you provide detailed and high-quality information in these
                                                    fields: Language, Biography, Skills, and Job Experiences.
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="step-inner-content">
                                            ...
                                            <div class="field field-type-select"
                                                ...
                                                <div class="field-content">
                                                    ...
                                                    <select
                                                        ...
                                                        @endif name="native_language" id="native_language"></select>
                                                    <i class="icon-arrow-down"></i>
                                                </div>
                                            </div>
                                            <div class="field-error-msg" id="field_error_native_language"></div>
                                            <div class="table-repeater" data-name="Other Languages"
                                                ...
                                                <div class="repeater-form">
                                                    <div class="field-group-validations"
                                                         data-group-validation-relation="and" id="more_language">
                                                        <div class="repeater-row">
                                                            <div class="row">
                                                                <div class="col">
                                                                    <div
                                                                        class="field field-type-select field-language table-visible"
                                                                        data-required="true"
                                                                ...
                                                                <div class="col">
                                                                    <div
                                                                        class="field field-type-select field-level table-visible"
                                                                        data-required="true"
                                                                        data-field-defualt-text="Select Item"
                                                                        data-btn-submit-text="Select"
                                                                        data-type="select">
                                                ...
                                                <div class="repeater-form">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-12 col-sm-6">
                                                                <div class="field field-type-select table-visible"
                                                                    ...
                                                                    <div class="field-content">
                                                                        ...
                                                                        <select name="skills_type" id="skills_type">
                                                                            <option value="sport_skill">Sport Skill
                                                                            </option>
                                                                            <option value="dance_skill">Dance Skill
                                                                            </option>
                                                                            <option value="singing_skill">Singing
                                                                                Skill
                                                                            </option>
                                                                            <option value="acting_skill">Acting Skill
                                                                            </option>
                                                                            <option value="musical_instrument_skill">
                                                                                Musical Instrument Skill
                                                                            </option>
                                                                            <option value="performance_skill">
                                                                                Performance Skill
                                                                            </option>
                                                                            <option value="driving_skill">Driving
                                                                                Skill
                                                                            </option>
                                                                            <option value="culinary_skill">Culinary
                                                                                Skill
                                                                            </option>
                                                                            <option value="visual_art_skill">Visual Art
                                                                                Skill
                                                                            </option>
                                                                ...
                                                                <div class="field-error-msg"
                                                                     id="field_error_skills_type"></div>
                                                            </div>
                                                            ...
                                                            <div class="col-12 col-sm-6" data-dependency="#skills_type"
                                                                ...
                                                                <div data-dependency="#skills_type"
                                                                    ...
                                                                    <div class="field-error-msg"
                                                                         id="field_error_other_skills"></div>
                                                                </div>

                                                                <!-- sub skill sport -->
                                                                <div data-dependency="#skills_type"
                                                                     data-dependency-value="sport_skill">
                                                                    <div class="field field-type-select table-visible"
                                                                         data-required="true"
                                                                         data-field-defualt-text="Select Item"
                                                                         data-col-name="tags"
                                                                         data-btn-submit-text="Select"
                                                                         data-type="select" data-field-search="true">
                                                                        <div class="field-content">
                                                                            <label for="sport_skill_type">Sport Skill
                                                                                <span
                                                                                    class="field-required-star">*</span></label>
                                                                            <select name="sport_skill_type"
                                                                                    id="sport_skill_type">
                                                                                ...
                                                                                <option value="table_tennis">Table
                                                                                    Tennis
                                                                                </option>
                                                                                <option value="horse_riding">Horse
                                                                                    Riding
                                                                                </option>
                                                                                <option value="kick_boxing">Kick
                                                                                    Boxing
                                                                                </option>
                                                                                ...
                                                                                <option value="body_building">Body
                                                                                    Building
                                                                                </option>
                                                                                <option value="snooker_and_pool">Snooker
                                                                                    and Pool
                                                                                </option>
                                                                ...
                                                                <!-- sub skill dance -->
                                                                <div data-dependency="#skills_type"
                                                                     data-dependency-value="dance_skill">
                                                                    <div class="field field-type-select table-visible"
                                                                         data-required="true"
                                                                         data-field-defualt-text="Select Item"
                                                                         data-col-name="tags"
                                                                         ...
                                                                         data-type="select" data-field-search="true">
                                                                        <div class="field-content">
                                                                            <label for="dance_skill_type">Dance Skill
                                                                                <span
                                                                                    class="field-required-star">*</span></label>
                                                                            <select name="dance_skill_type"
                                                                                    id="dance_skill_type">
                                                                                <option value="hip_hop_dance">Hip hop
                                                                                    dance
                                                                                </option>
                                                                                <option value="ballet">Ballet</option>
                                                                                <option value="tap_dance">Tap dance
                                                                                </option>
                                                                                <option value="modern_dance">Modern
                                                                                    Dance
                                                                                </option>
                                                                                <option value="ballroom">Ballroom
                                                                                </option>
                                                                                <option value="breakdancing">
                                                                                    Breakdancing
                                                                                </option>
                                                                                <option value="salsa">Salsa</option>
                                                                                <option value="street_dance">Street
                                                                                    dance
                                                                                </option>
                                                                                <option value="belly_dance">Belly
                                                                                    dance
                                                                                </option>
                                                                                <option value="bharatanatyam">
                                                                                    Bharatanatyam
                                                                                </option>
                                                                                <option value="cuban_rumba">Cuban
                                                                                    rumba
                                                                                </option>
                                                                                <option value="samba">Samba</option>
                                                                                <option value="mambo">Mambo</option>
                                                                                <option value="foxtrot">Foxtrot</option>
                                                                                <option value="swing_music">Swing
                                                                                    music
                                                                                </option>
                                                                                ...
                                                                                <option value="folk_dance">Folk dance
                                                                                </option>
                                                                                <option value="contemporary_dance">
                                                                                    Contemporary dance
                                                                                </option>
                                                                                <option value="jazz_dance">Jazz dance
                                                                                </option>
                                                                                <option value="latin_dance">Latin
                                                                                    dance
                                                                                </option>
                                                                                <option value="other">Other</option>
                                                                            </select>
                                                                ...
                                                                <div data-dependency="#skills_type"
                                                                    ...
                                                                    <div class="field field-type-select  table-visible"
                                                                         ...
                                                                         data-type="select" data-field-search="true">
                                                                        <div class="field-content">
                                                                            <label for="singing_skill_type">Singing
                                                                                Skill <span class="field-required-star">*</span></label>
                                                                            <select name="singing_skill_type"
                                                                                    id="singing_skill_type">
                                                                                <option value="disco">Disco</option>
                                                                                <option value="techno">Techno</option>
                                                                                <option value="reggae">Reggae</option>
                                                                                <option value="metal">Metal</option>
                                                                                <option value="r&b">R&B</option>
                                                                                <option value="classical_music">
                                                                                    Classical music
                                                                                </option>
                                                                ...
                                                                <div data-dependency="#skills_type"
                                                                    ...
                                                                    <div class="field field-type-select table-visible"
                                                                         ...
                                                                         data-type="select" data-field-search="true">
                                                                        <div class="field-content">
                                                                            <label for="acting_skill_type">Acting Skill
                                                                                <span
                                                                                    class="field-required-star">*</span></label>
                                                                            <select name="acting_skill_type"
                                                                                    id="acting_skill_type">
                                                                                <option value="communication">
                                                                                    Communication
                                                                                </option>
                                                                                <option value="creativity">Creativity
                                                                                </option>
                                                                                <option value="memorisation_work">
                                                                                    Memorisation work
                                                                                </option>
                                                                                <option value="physical_performance">
                                                                                    Physical performance
                                                                                </option>
                                                                                <option value="theoretical_knowledge">
                                                                                    Theoretical knowledge
                                                                                </option>
                                                                                <option value="teamwork">Teamwork
                                                                                </option>
                                                                                <option value="other">Other</option>
                                                                            </select>
                                                                            <i class="icon-arrow-down"></i>
                                                                    ...
                                                                    <div class="field field-type-select table-visible"
                                                                        ...
                                                                        <div class="field-content">
                                                                            ...
                                                                            <select name="musical_instrument_skill_type"
                                                                                ...
                                                                                <option value="accordion">Accordion
                                                                                </option>
                                                                                <option value="xylophone">Xylophone
                                                                                </option>
                                                                                <option value="electronic_keyboard">
                                                                                    Electronic Keyboard
                                                                                </option>
                                                                ...
                                                                <div data-dependency="#skills_type"
                                                                    ...
                                                                    <div class="field field-type-select table-visible"
                                                                         ...
                                                                         data-type="select" data-field-search="true">
                                                                        <div class="field-content">
                                                                            <label for="performance_skill_type">Performance
                                                                                Skill <span class="field-required-star">*</span></label>
                                                                            <select name="performance_skill_type"
                                                                                    id="performance_skill_type">
                                                                                <option value="voice_and_speech_skills">
                                                                                    Voice and Speech Skills
                                                                                </option>
                                                                                <option value="physical_skills">Physical
                                                                                    Skills
                                                                                </option>
                                                                                <option value="character_development">
                                                                                    Character Development
                                                                                </option>
                                                                                <option value="understanding_of_text">
                                                                                    Understanding of Text
                                                                                </option>
                                                                                <option value="emotional_availability">
                                                                                    Emotional Availability
                                                                                </option>
                                                                                <option value="collaboration_skills">
                                                                                    Collaboration Skills
                                                                                </option>
                                                                                <option value="improvisation_skills">
                                                                                    Improvisation Skills
                                                                                </option>
                                                                                <option
                                                                                    value="discipline_and_professionalism">
                                                                                    Discipline and Professionalism
                                                                                </option>
                                                                                <option value="auditioning_skills">
                                                                                    Auditioning Skills
                                                                                </option>
                                                                                <option value="stage_presence">Stage
                                                                                    Presence
                                                                                </option>
                                                                                <option value="other">Other</option>
                                                                            </select>
                                                                ...
                                                                <div data-dependency="#skills_type"
                                                                    ...
                                                                    <div class="field field-type-select table-visible"
                                                                         ...
                                                                         data-type="select" data-field-search="true">
                                                                        <div class="field-content">
                                                                            <label for="driving_skill_type">Driving
                                                                                Skill <span class="field-required-star">*</span></label>
                                                                            <select name="driving_skill_type"
                                                                                    id="driving_skill_type">
                                                                                <option value="motorcycle_license">
                                                                                    Motorcycle License
                                                                                </option>
                                                                                <option
                                                                                    value="passenger_vehicle_license">
                                                                                    Passenger Vehicle License
                                                                                </option>
                                                                                <option
                                                                                    value="commercial_driver's_license">
                                                                                    Commercial Driver's License
                                                                                </option>
                                                                                <option value="bus/minibus_license">
                                                                                    Bus/Minibus License
                                                                                </option>
                                                                                <option value="heavy_vehicle_license">
                                                                                    Heavy Vehicle License
                                                                                </option>
                                                                                <option value="trailer_license">Trailer
                                                                                    License
                                                                                </option>
                                                                                <option
                                                                                    value="special_vehicle_licenses">
                                                                                    Special Vehicle Licenses
                                                                                </option>
                                                                                <option
                                                                                    value="light_aircraft_pilot_licence_(lapl)">
                                                                                    light aircraft pilot licence (LAPL)
                                                                                </option>
                                                                                <option
                                                                                    value="the_private_pilot_licence_(ppl)">
                                                                                    the private pilot licence (PPL)
                                                                                </option>
                                                                                <option
                                                                                    value="sailplane_pilot_licence_(spl)">
                                                                                    sailplane pilot licence (SPL)
                                                                                </option>
                                                                                <option
                                                                                    value="balloon_pilot_licence_(bpl)">
                                                                ...
                                                                <div data-dependency="#skills_type"
                                                                    ...
                                                                    <div class="field field-type-select table-visible"
                                                                         ...
                                                                         data-type="select" data-field-search="true">
                                                                        <div class="field-content">
                                                                            <label for="culinary_skill_type">Culinary
                                                                                Skill <span class="field-required-star">*</span></label>
                                                                            <select name="culinary_skill_type"
                                                                                    id="culinary_skill_type">
                                                                                <option value="basic_cooking">Basic
                                                                                    Cooking
                                                                                </option>
                                                                                <option
                                                                                    value="advanced_culinary_techniques">
                                                                                    Advanced Culinary Techniques
                                                                                </option>
                                                                                <option value="baking_&_pastry">Baking &
                                                                                    Pastry
                                                                                </option>
                                                                                <option value="international_cuisine">
                                                                                    International Cuisine
                                                                                </option>
                                                                                <option value="diet-specific_cooking">
                                                                                    Diet-Specific Cooking
                                                                                </option>
                                                                                <option value="beverage_&_mixology">
                                                                                    Beverage & Mixology
                                                                                </option>
                                                                                <option value="plating_skills">Plating
                                                                                    Skills
                                                                                </option>
                                                                                <option value="other">Other</option>
                                                                            </select>
                                                                ...
                                                                <div data-dependency="#skills_type"
                                                                    ...
                                                                    <div class="field field-type-select table-visible"
                                                                         ...
                                                                         data-type="select" data-field-search="true">
                                                                        <div class="field-content">
                                                                            <label for="visual_art_skill_type">Visual
                                                                                Art Skill <span
                                                                                    class="field-required-star">*</span></label>
                                                                            <select name="visual_art_skill_type"
                                                                                ...
                                                                                <option value="textile_and_fiber_art">
                                                                                    Textile and Fiber Art
                                                                                </option>
                                                                                <option value="calligraphy_&_lettering">
                                                                                    Calligraphy & Lettering
                                                                                </option>
                                                                                <option value="ceramics_&_pottery">
                                                                                    Ceramics & Pottery
                                                                                </option>
                                                                                <option value="other">Other</option>
                                                                            </select>
                                                        ...
                                                        <div class="field field-type-nr-input" data-type="text"
                                                            ...
                                                            <div class="field-content">
                                                                <label for="sport_other_skills">Sport Skill Name <span
                                                                        class="field-required-star">*</span></label>
                                                                <input type="text" name="sport_other_skills"
                                                                       id="sport_other_skills">
                                                            </div>
                                                        </div>
                                                        <div class="field-error-msg"
                                                             id="field_error_sport_other_skills"></div>
                                                    </div>
                                                        ...
                                                        <div class="field field-type-nr-input" data-type="text"
                                                            ...
                                                            <div class="field-content">
                                                                <label for="dance_other_skills">Dance Skill Name <span
                                                                        class="field-required-star">*</span></label>
                                                                <input type="text" name="dance_other_skills"
                                                                       id="dance_other_skills">
                                                            </div>
                                                        </div>
                                                        <div class="field-error-msg"
                                                             id="field_error_dance_other_skills"></div>
                                                    </div>
                                                    ...
                                                    <div class="repeater-row" data-dependency="#singing_skill_type"
                                                        ...
                                                        <div class="field field-type-nr-input" data-type="text"
                                                             data-required="true">
                                                            <div class="field-content">
                                                                <label for="singing_other_skills">Singing Skill Name
                                                        ...
                                                        <div class="field-error-msg"
                                                             id="field_error_singing_other_skills"></div>
                                                    </div>
                                                        ...
                                                        <div class="field field-type-nr-input" data-type="text"
                                                            ...
                                                            <div class="field-content">
                                                                <label for="acting_other_skills">Acting Skill Name <span
                                                                        class="field-required-star">*</span></label>
                                                                <input type="text" name="acting_other_skills"
                                                                       id="acting_other_skills">
                                                            </div>
                                                        </div>
                                                        <div class="field-error-msg"
                                                             id="field_error_acting_other_skills"></div>
                                                    </div>

                                                    <!-- other sub skill musical -->
                                                    <div class="repeater-row"
                                                         data-dependency="#musical_instrument_skill_type"
                                                         data-dependency-value="other">
                                                        <div class="field field-type-nr-input" data-type="text"
                                                             data-required="true">
                                                            <div class="field-content">
                                                                <label for="musical_instrument_other_skills">Musical
                                                                    Instrument Skill Name <span
                                                                        class="field-required-star">*</span></label>
                                                                <input type="text"
                                                                       name="musical_instrument_other_skills"
                                                    ...
                                                    <div class="repeater-row" data-dependency="#performance_skill_type"
                                                        ...
                                                        <div class="field field-type-nr-input" data-type="text"
                                                             data-required="true">
                                                            <div class="field-content">
                                                                <label for="performance_other_skills">Performance Skill
                                                                    Name <span
                                                                        class="field-required-star">*</span></label>
                                                        ...
                                                        <div class="field-error-msg"
                                                             id="field_error_performance_other_skills"></div>
                                                    </div>
                                                    ...
                                                    <div class="repeater-row" data-dependency="#driving_skill_type"
                                                        ...
                                                        <div class="field field-type-nr-input" data-type="text"
                                                             data-required="true">
                                                            <div class="field-content">
                                                                <label for="driving_other_skills">Driving Skill Name
                                                                    <span class="field-required-star">*</span></label>
                                                        ...
                                                        <div class="field-error-msg"
                                                             id="field_error_driving_other_skills"></div>
                                                    </div>
                                                    ...
                                                    <div class="repeater-row" data-dependency="#culinary_skill_type"
                                                        ...
                                                        <div class="field field-type-nr-input" data-type="text"
                                                             data-required="true">
                                                            <div class="field-content">
                                                                <label for="culinary_other_skills">Culinary Skill Name
                                                                    <span class="field-required-star">*</span></label>
                                                        ...
                                                        <div class="field-error-msg"
                                                             id="field_error_culinary_other_skills"></div>
                                                    </div>
                                                    ...
                                                    <div class="repeater-row" data-dependency="#visual_art_skill_type"
                                                        ...
                                                        <div class="field field-type-nr-input" data-type="text"
                                                             data-required="true">
                                                            <div class="field-content">
                                                                <label for="visual_art_other_skills">Visual Art Skill
                                                                    Name <span
                                                                        class="field-required-star">*</span></label>
                                                        ...
                                                        <div class="field-error-msg"
                                                             id="field_error_visual_art_other_skills"></div>
                                                    </div>
                                                    ...
                                                    <div class="repeater-row">
                                                        <div class="field field-type-text-area" data-type="textarea"
                                                            ...
                                                            <div class="field-content">
                                                                <label for="skills_description">Skill
                                                                    Description</label>
                                                                <textarea name="skills_description"
                                                                          id="skills_description" rows="5"></textarea>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="repeater-row tabs" data-active="skill_photo">
                                                        ...
                                                        <div class="tabs-contents">
                                                                ...
                                                                <div class="field field-type-upload" data-type="upload">
                                                                    <div class="upload-drop-zone" data-limit-count="5"
                                                                        ...
                                                                        <input type="hidden" class="input-drop-zone"
                                                                               name="photos" id="skill_photos">
                                                                        <label>Your Photos</label>
                                                                        <i class="icon-upload"></i>
                                                                        <div class="upload-title">
                                                                            <b>Click to upload</b> <span
                                                                                class="visible-desktop">or drag and drop</span>
                                                                            photos
                                                                        </div>
                                                                        <div class="upload-description">
                                                                            Allowed format: PNG, JPG (Up to: <span
                                                                                class="limit-count">5</span> photos/100
                                                                            Mb (20 Mb per photo))
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div
                                                                    class="upload-drop-zone-file grid col-count-3"></div>
                                                            </div>
                                                                    ...
                                                                    <div class="upload-drop-zone" data-limit-count="5"
                                                                        ...
                                                                        <div class="upload-description">
                                                                            Allowed format: MP4 (Up to: <span
                                                                                class="limit-count">5</span> photos/350
                                                                            Mb (70 Mb per video))
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div class="tab-content-item" data-tab-target="skill_audio">
                                                                ...
                                                                <div
                                                                    class="upload-drop-zone-file grid col-count-2"></div>
                                                            </div>
                                                        </div>
                                                    </div>
                                    ...
                                    <!-- job experiences -->
                                    <div class="form-section">
                                        <div class="form-section-label"><span>Job Experiences <span
                                                    class="field-required-star">*</span></span></div>
                                        <div class="form-section-content">
                                                ...
                                                <div class="repeater-form">
                                                    ...
                                                    <div class="repeater-row">
                                                        <div class="field field-type-select table-visible"
                                                             ...
                                                             data-field-search="true">
                                                            <div class="field-content">
                                                                <label for="job_experience_type">Job Experience Type
                                                                    <span class="field-required-star">*</span></label>
                                                                <select name="type" id="job_experience_type">
                                                                    <option value="no_job_experience">No Job
                                                                        Experience
                                                                    </option>
                                                                    ...
                                                                    <option value="live_performances">Live
                                                                        Performances
                                                                    </option>
                                                                    <option value="magazine_books">Magazine/Books
                                                                    </option>
                                                                    <option value="voice_acting">Voice acting</option>
                                                                    <option value="dvd_blue_ray_cd">DVD/Blue-ray/CD
                                                                    </option>
                                                                    <option value="music_activity">Music activity
                                                                    </option>
                                                        ...
                                                        <div class="field-error-msg"
                                                             id="field_error_job_experience_type"></div>
                                                    </div>

                                                    <!-- other type -->
                                                    <div data-dependency="#job_experience_type"
                                                         data-dependency-value="other">
                                                        <div class="field field-type-nr-input" data-type="text"
                                                             data-required="true">
                                                            <div class="field-content">
                                                                <label for="other_job_experience_type">Other Job
                                                                    Experience Type <span
                                                                        class="field-required-star">*</span></label>
                                                                <input type="text" name="other_type"
                                                                       id="other_job_experience_type">
                                                            </div>
                                                        </div>
                                                        <div class="field-error-msg"
                                                             id="field_error_other_job_experience_type"></div>
                                                    </div>

                                                    <!-- date -->
                                                    <div class="repeater-row" data-dependency="#job_experience_type"
                                                         data-dependency-value="no_job_experience"
                                                         data-dependency-is-not="true">
                                                        <div class="row">

                                                            <!-- year -->
                                                            <div class="col-6">
                                                                <div
                                                                    class="field field-type-select wheel-mode table-visible"
                                                    ...
                                                    <div class="repeater-row" data-dependency="#job_experience_type"
                                                        ...
                                                        <div class="field field-type-text-area" data-required="true"
                                                             data-type="textarea" data-max-length="1000">
                                                            <div class="field-content">
                                                                <label for="description">Job Experience Description
                                                                    <span class="field-required-star">*</span></label>
                                                    ...
                                                    <div class="repeater-row tabs" data-active="job_exp_photo"
                                                         ...
                                                         data-dependency-value="no_job_experience"
                                                         data-dependency-is-not="true">
                                                        <div class="field-hint bottom-space">Increase your chances of
                                                            receiving more job offers by uploading media that showcase
                                                        ...
                                                        <div class="tabs-contents">
                                                            <div class="tab-content-item"
                                                                 data-tab-target="job_exp_photo">
                                                                <div class="field field-type-upload" data-type="upload">
                                                                    <div class="upload-drop-zone" data-limit-count="5"
                                                                         data-limit-size="20" data-ratio="3/4,4/3"
                                                                         data-accept=".png,.jpg">
                                                                        <input type="hidden" class="input-drop-zone"
                                                                               name="photos" id="job_exp_photos">
                                                                        <label>Your Photos</label>
                                                                        <i class="icon-upload"></i>
                                                                        <div class="upload-title">
                                                                            <b>Click to upload</b> <span
                                                            ...
                                                            <div class="tab-content-item"
                                                                 data-tab-target="job_exp_video">
                                                                <div class="field field-type-upload" data-type="upload">
                                                                    <div class="upload-drop-zone" data-limit-count="5"
                                                                         data-limit-size="70" data-accept=".mp4">
                                                                        <input type="hidden" class="input-drop-zone"
                                                                               name="videos" id="job_exp_videos">
                                                                        ...
                                                                        <div class="upload-description">
                                                                            Allowed format: MP4 (Up to: <span
                                                                                class="limit-count">5</span> videos/350
                                                                            Mb (70 Mb per video))
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div class="tab-content-item"
                                                                 data-tab-target="job_exp_audio">
                                                                <div class="field field-type-upload" data-type="upload">
                                                                    <div class="upload-drop-zone" data-limit-count="5"
                                                                         data-limit-size="20" data-accept=".mp3">
                                                                        <input type="hidden" class="input-drop-zone"
                                                                               name="audios" id="job_exp_audios">
                                                                        ...
                                                                        <div class="upload-description">
                                                                            Allowed format: MP3 (Up to: <span
                                                                                class="limit-count">5</span> audios/100
                                                                            Mb (20 Mb per audio))
                                                                        </div>
                                                                    </div>
                                                                </div>
                                            ...
                                            <div class="table-repeater" id="table_job_experiences_pdf"
                                                 ...
                                                 data-required="true"
                                                 data-dependency="#job_experiences_pdf"
                                                 data-dependency-value="tempCheck" data-deep-check="false">
                                                ...
                                                <div class="repeater-form">
                                                    ...
                                                    <!-- hint -->
                                                    <div class="field-hint">Enter your job experiences by uploading your
                                                        resume here.
                                                    </div>

                                                    <!-- upload -->
                                                    <div class="repeater-row">
                                                        <div class="field field-type-upload table-visible"
                                                             data-type="upload" data-required="true">
                                                            <div class="upload-drop-zone" data-limit-count="1"
                                                                 data-limit-size="20" data-accept=".pdf">
                                                                <input type="hidden" class="input-drop-zone"
                                                                       name="job_exp_pdf" id="job_exp_pdf">
