    ...
    <div class="app-bar">
        <div class="app-bar-container">
            <div class="leading">
                ...
                <a href="./home.html" class="btn btn-icon app-bar-mobile" aria-label="Back">
            ...
            <div class="actions">
                <div class="app-lang app-bar-desktop">
                    ...
                    @if(App::getLocale() == 'ja')
                     active
                    @endif
                    " aria-label="Change Language To Japan">
                        JP
                    </a>
                ...
                <a href="/dashboard-models" class="user-dashboard">
                    <i class="icon-user"></i>
                    <!--                    <img src="../assets/img/lazy-1x1.webp" class="lazy" data-src="../assets/img/1x1/001.webp"-->
                    <!--                         width="80" height="80" alt="Model">-->
                    <!--                    <noscript>-->
                    <!--                        <img src="../assets/img/1x1/001.webp" width="80" height="80" alt="Model">-->
                    <!--                    </noscript>-->
                </a>
            </div>
        </div>
    ...
    <div class="search">
            ...
            <div class="recent-search-section">
                ...
                <div class="recent-model">
                    <a href="./model-page.html">
                        <img src="../assets/img/lazy-3x4.webp" class="lazy" data-src="../assets/img/3x4/012.webp"
                             width="120" height="160" alt="Model">
                        <noscript>
                            <img src="../assets/img/3x4/012.webp" width="120" height="160" alt="Model">
                        </noscript>
                        <span>Maaya</span>
                    </a>
                    <a href="./model-page.html">
                        <img src="../assets/img/lazy-3x4.webp" class="lazy" data-src="../assets/img/3x4/011.webp"
                             width="120" height="160" alt="Model">
                        <noscript>
                            <img src="../assets/img/3x4/011.webp" width="120" height="160" alt="Model">
                        </noscript>
                        <span>Soya</span>
                    </a>
                    <a href="./model-page.html">
                    ...
                    <a href="./model-page.html">
                        <img src="../assets/img/lazy-3x4.webp" class="lazy" data-src="../assets/img/3x4/028.webp"
                             width="120" height="160" alt="Model">
                        <noscript>
                            <img src="../assets/img/3x4/028.webp" width="120" height="160" alt="Model">
                        </noscript>
                        <span>Nycoli</span>
                    </a>
                </div>
        ...
        <div class="search-result">
            ...
            <ul>
                <li>
                    <a href="./model-page.html">
                        <img src="../assets/img/lazy-1x1.webp" class="lazy" data-src="../assets/img/1x1/003.webp"
                             width="80" height="80" alt="model">
                        <noscript>
                            <img src="../assets/img/1x1/005.webp" width="80" height="80" alt="model">
                        </noscript>
                        <div>
                ...
                <li>
                    <a href="./model-page.html">
                        <img src="../assets/img/lazy-1x1.webp" class="lazy" data-src="../assets/img/1x1/004.webp"
                             width="80" height="80" alt="model">
                        <noscript>
                            <img src="../assets/img/1x1/005.webp" width="80" height="80" alt="model">
                        </noscript>
                ...
                <li>
                    <a href="./model-page.html">
                        <img src="../assets/img/lazy-1x1.webp" class="lazy" data-src="../assets/img/1x1/005.webp"
                             width="80" height="80" alt="model">
                        <noscript>
                            <img src="../assets/img/1x1/005.webp" width="80" height="80" alt="model">
                        </noscript>
